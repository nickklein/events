            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-8">
                    <div className="px-8 py-8 border-b border-gray-200 dark:border-gray-700">
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">{event.title}</h1>
                        {event.description && (
                    ...
                    <div className="p-8">
                        <div className="mb-8">
                            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Share Links</h3>
                            <div className="space-y-3">
                                <button
                                    onClick={copyPublicUrl}
                                    className="w-full p-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-md text-left flex items-center justify-between group transition-all border border-gray-200 dark:border-gray-600"
                                >
                                    <div>
                                        <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">Public Voting Link</div>
                                ...
                                <button
                                    ...
                                    className="w-full p-4 bg-amber-50 dark:bg-amber-900 hover:bg-amber-100 dark:hover:bg-amber-800 rounded-md text-left flex items-center justify-between group transition-all border border-amber-200 dark:border-amber-700"
                                >
                                    <div>
                                        <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">Admin Link (Keep Secret!)</div>
                                        <div className="text-xs text-gray-600 dark:text-amber-300 break-all mt-0.5">
                                            {window.location.href}
                                        </div>
                                    </div>
                                    <svg className="w-5 h-5 text-amber-600 dark:text-amber-400 group-hover:text-amber-700 dark:group-hover:text-amber-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                    </svg>
                                </button>
                            </div>
                        ...
                        {bestDate && bestLocation && (
                            <div className="bg-emerald-50 dark:bg-emerald-900 border border-emerald-200 dark:border-emerald-700 rounded-lg p-6 mb-8">
                                <h3 className="font-bold text-emerald-900 dark:text-emerald-100 text-lg mb-4 flex items-center gap-2">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">Admin Actions</h2>
                    <div className="flex gap-3 flex-wrap">
                        {event.status === 'active' && (
                            <button
                                onClick={handleClose}
                                className="px-6 py-3 bg-amber-600 dark:bg-amber-700 hover:bg-amber-700 dark:hover:bg-amber-800 text-white font-semibold rounded-md transition-colors"
                            >
                                Close Voting
                            </button>
                        )}
                        {!showDeleteConfirm ? (
                            <button
                                ...
                                className="px-6 py-3 bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-800 text-white font-semibold rounded-md transition-colors"
                            >
                                Delete Event
                            </button>
                        ) : (
                            <div className="flex gap-3 items-center flex-wrap">
                                <span className="text-red-600 dark:text-red-400 font-semibold">Are you sure?</span>
                                <button
                                ...
                                <button
                                    ...
                                    className="px-6 py-3 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-md transition-colors"
                                >
                                    Cancel
                                </button>
                            </div>
